...
export default function Footer() {
  return (
    <footer className="hero-silk text-white mt-20 lg:mt-28">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                href="https://www.linkedin.com/company/deutsche-foerderberatung/"
                target="_blank"
                rel="noopener noreferrer"
                className="h-9 w-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-gold/20 transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://www.instagram.com/deutsche_foerderberatung/"
                target="_blank"
                rel="noopener noreferrer"
                className="h-9 w-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-gold/20 transition-colors"
              ...
              <a
                href="https://www.tiktok.com/@deutsche_foerderberatung"
                target="_blank"
                rel="noopener noreferrer"
                className="h-9 w-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-gold/20 transition-colors"
                aria-label="TikTok"
              ...
              <a
                href="https://www.youtube.com/@Deutsche_F%C3%B6rderberatung"
                target="_blank"
                rel="noopener noreferrer"
                className="h-9 w-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-gold/20 transition-colors"
                aria-label="YouTube"
